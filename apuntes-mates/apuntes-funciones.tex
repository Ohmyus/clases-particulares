    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[width=\linewidth,
                ...
                \addplot[ultra thick, color=blue, domain=-2:2, samples=50]{x^2};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[width=\linewidth,
                ...
                \addplot[ultra thick, color=blue, domain=0:4, samples=50]{ln(x)};
            \end{axis}
        \end{tikzpicture}
...
\begin{examplebox}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        ...
        \addplot[color=blue, domain=-1:1, samples=30, ultra thick]{0.5 - x^2};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=gray!5, thick] coordinates {(0.5,0.25)};
        \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\linewidth}
        ...
        \addplot[color=blue, domain=-2:2, samples=30, ultra thick]{exp(x)};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=gray!5, thick] coordinates {(0,1)};
        \end{axis}
        \end{tikzpicture}
    \end{minipage}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        ...
        \addplot[color=blue, domain=-1:0.99, samples=30, ultra thick]{1/(x-1)};
        \addplot[color=blue, domain=1.01:3, samples=30, ultra thick]{1/(x-1)};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=gray!5, thick] coordinates {(2, 1)};
        \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.45\linewidth}
        ...
        \addplot[color=blue, domain=-2:0, samples=60, ultra thick]{0.75+0.2*x};
        \addplot[color=blue, domain=0:2, samples=60, ultra thick]{0.25-0.25*x};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=gray!5, thick] coordinates {(0, 0.75)};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=gray!5, thick] coordinates {(0, 0.25)};
        \addplot[mark=*, mark size = 3pt, draw=blue, fill=blue, thick] coordinates {(0, 0.5)};
        \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \end{center}
...
Sin embargo, este límite no tiene por qué estar determinado, de hecho, en la mayoría de funciones no lo está. Solamente en funciones que presentan asíntotas horizontales, estos límites existen. En el resto de casos, este límite siempre toma valores de $\pm \infty$.
