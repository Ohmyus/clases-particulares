...
\begin{examplebox}
    ...
    \begin{minipage}[b]{0.45\linewidth}
        ...
        \addplot[color=red, domain=-1:0.99, samples=30, ultra thick]{1/(x-1)};
        \addplot[color=red, domain=1.01:3, samples=30, ultra thick]{1/(x-1)};
        \addplot[mark=*, mark size = 3pt, draw=red, fill=gray!5, thick] coordinates {(2, 1)};
        \end{axis}
        \end{tikzpicture}
    \end{minipage}
    \hfill
